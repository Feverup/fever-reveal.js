...
reveal.js fork with customizations for Fever Talks.

See specific instructions for this fork in [READMEFEVER.md](READMEFEVER.md).

## reveal.js original README.md
